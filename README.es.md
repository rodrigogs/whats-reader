...
| <img src="examples/images/5-bookmarks.png" width="400" /> | <img src="examples/images/6-statistics.png" width="400" /> |
 Descárgalo desde [nodejs.org](https://nodejs.org/) y ejecuta el instalador.
...
5. Guarda el archivo (puedes usar AirDrop a tu Mac, guardar en Archivos o enviarlo por correo)
...
### Requisitos Previos. Sin servidores, sin nube, sin transmisión de datos.
...
---funciona porque nada requiere conexión.
